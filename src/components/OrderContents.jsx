              ...
              <div className={"flex gap-x-10"}>
                ...
                <div>
                  ...
                  <div className={"flex flex-col gap-y-4"}>
                    <span>Вес блюда: {orderItem.weight * itemQuantity}</span>
                    <span>
                      Ккал {orderItem.kilocalories * itemQuantity} гр.
                    </span>
                    <span>Белки {orderItem.proteins * itemQuantity} гр.</span>
                    <span>Жиры {orderItem.fats * itemQuantity} гр.</span>
                    <span>Углеводы {orderItem.carbons * itemQuantity} гр.</span>
                  </div>
                </div>
              </div>
              {isChangeQuantityItem && (
